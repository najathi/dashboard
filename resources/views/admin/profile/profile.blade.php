                ...
                <div class="card-body">
                    <div class="user-profile">
                        <div class="row">
                            ...
                            <div class="col-lg-8">
                                <div class="user-profile-name">Jone Doe</div>
                                <div class="user-Location"><i class="ti-location-pin"></i> Sydney, Australia</div>
                                        ...
                                        <div role="tabpanel" class="tab-pane active" id="1">
                                            <div class="contact-information">
                                                ...
                                                <div class="email-content">
                                                    ...
                                                    <span class="contact-email">hello@vuejsadmin.com</span>
                                                </div>
                                                <div class="website-content">
                                                    <span class="contact-title">Website:</span>
                                                    <span class="contact-website">www.vuejsadmin.com</span>
                                                </div>
                                                <div class="skype-content">
                                                    <span class="contact-title">Skype:</span>
                                                    <span class="contact-skype">vue.js admin </span>
                                                </div>
                                            </div>
                ...
                <div class="recent-comment">
                    <div class="media">
                        ...
                        <div class="media-body">
                            <h4 class="media-heading">Jone Doe</h4>
                    ...
                    <div class="media">
                        ...
                        <div class="media-body">
                            <h4 class="media-heading">Sara Maggi</h4>
                            <p>Cras sit amet nibh libero, in gravida nulla. Nulla vel metus scelerisque ante sollicitudin commodo. </p>
                            <div class="comment-action">
                    ...
                    <div class="media no-border">
                        ...
                        <div class="media-body">
                            <h4 class="media-heading">Mr. Wolf</h4>
                            <p>Cras sit amet nibh libero, in gravida nulla. Nulla vel metus scelerisque ante sollicitudin commodo. </p>
                            <div class="comment-action">
