        ...
        <div class="nano">
            <div class="nano-content">
                <ul>
                    ...
                    <li class="active"><a href="{{ url('/home')}}"><i class="ti-home"></i> Dashboard </a></li>
                    ...
                    <li class="label">Users Control</li>
                    <li><a href="{{ route('admin.users.index') }}"><i class="fa fa-users" aria-hidden="true"></i> All users </a></li>
